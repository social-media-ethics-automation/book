...
% TODO: World not designed for them
...
This way of managing disability gives tools to disabled people to help them become more "normal." So the disabled people person is able to move the a world that was not designed for them, but there is still an expectation that disabled people must become more "normal."

% TODO: Also cost, like financial
...
& TODO: note: that universal design has been modified to be less certain, and been replaced by things like "inclusive design"
